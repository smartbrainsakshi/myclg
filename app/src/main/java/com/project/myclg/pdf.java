...
public class pdf extends Activity {
    ...
    public static String D_url="https://docs.google.com/gview?embedded=true&url=http://prince.coolpage.biz/";
    String file_url;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(extras !=null) {
            ...
            file_url =  "https://docs.google.com/gview?embedded=true&url=https://sakshipooja21.000webhostapp.com/10_chapter%202%20healthcare%20environment%20in%20india.pdf";
        }
        Log.e("link",file_url);
        displayInputDialog();
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                File folder = new File(Environment.getExternalStorageDirectory() + File.separator +"myCLG/books/");
                if(!folder.exists())
                ...
                // Output stream
                OutputStream output = new FileOutputStream("/sdcard/myCLG/books/B"+todayDate+".pdf");
        ...
        protected void onPostExecute(String file) {
            ...
            String imagePath = Environment.getExternalStorageDirectory().toString() + "/myCLG/books/B"+todayDate+".pdf";
            ...
            Uri uri = Uri.parse(Environment.getExternalStorageDirectory().getPath()+ "/myCLG/books/");
            Intent intent = new Intent(Intent.ACTION_VIEW,uri);
            Intent toLaunch = new Intent();
            toLaunch.setAction(Intent.ACTION_VIEW);
            toLaunch.setDataAndType(Uri.fromFile(new File(Environment.getExternalStorageDirectory().getPath()+ "/myCLG/")), MimeTypeMap.getSingleton().getMimeTypeFromExtension("pdf"));

            PendingIntent contentIntent = PendingIntent.getActivity(getApplicationContext(), 0, toLaunch, 0);
