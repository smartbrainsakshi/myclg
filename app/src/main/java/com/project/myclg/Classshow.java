...
public class Classshow extends AppCompatActivity {
   ...
   urlpass="http://mmmut.ac.in/ModelPapers/sy_090916053027.pdf";
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final DatabaseReference dinosaursRef = database.getInstance().getReference("myclass/"+br+"/"+yr+"/"+sess);
                Log.e("data2", String.valueOf(dinosaursRef));
                dinosaursRef.child(br).child(yr).child(sess).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                          //  n++;
                           ...
                           // urlpass = String.valueOf(ds.getValue());
                            Log.e("data1",urlpass);
                ...
                Log.e("reference", dinosaursRef.getDatabase().toString());
                ...
                Intent in=new Intent(Classshow.this,pdf.class);
